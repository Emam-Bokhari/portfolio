  ...
  return (
    <div className="bg-[#222935]  md:p-6 p-6">
      <footer className="footer md:p-6 text-white max-w-7xl mx-auto">
        <aside>
          <h2 className="text-[#00c0c5] text-lg" >MR</h2>
          <p>
            <span className="text-xl">Moshfiqur Rahman</span>
            <br />
            <address>Frontend Developer</address>
          </p>
        </aside>
        <nav className="">
      ...
      <p className="text-center text-sm text-white pb-3">
        Copyright © 2023 - All right reserved Moshfiqur Rahman
      </p>
    </div>
  );
};
